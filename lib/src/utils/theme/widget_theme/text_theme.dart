...
class KTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
      ...
      displaySmall: GoogleFonts.montserrat(fontSize: 20.0, fontWeight: FontWeight.w700, color: kDarkColor),
  ...
  static TextTheme darkTextTheme = TextTheme(
      ...
      displaySmall: GoogleFonts.montserrat(fontSize: 20.0, fontWeight: FontWeight.w700, color: kWhiteColor),
